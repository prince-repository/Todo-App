...
export function TodoList({
  ...
  return (
   ...
   FilterTodos.map((item, idx) => (
        <li
          key={idx}
          className={`flex flex-col md:flex-row md:items-center md:justify-between gap-3 rounded-xl px-5  py-4 shadow-md transition-transform hover:scale-[1.02]    mx-2
          ${
            lightMode
              ? "bg-white shadow-gray-300"
              : "bg-gray-800 shadow-gray-700"
