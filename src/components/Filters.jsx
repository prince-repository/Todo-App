...
export const Filters = (props) => {
  ...
  return (
    <>
      <section className="flex mx-6  justify-center  w-full">
        <div className="w-[20%]">
          <h1 className="flex justify-start items-center gap-2 text-3xl p-2 ">
            Filter By <IoFilter className="text-3xl mt-3" />
          </h1>
        </div>

        <div className="w-[80%] grid grid-cols-2 gap-5 md:grid-cols-3 lg:grid-cols-6 mx-10">
          {/* Search Input */}
          ...
          <button
            ...
            className="lg:py-3 lg:px-3 py-2 px-2 bg-red-500 hover:bg-red-600 text-white   my-5 rounded-3xl shadow-md transition-all cursor-pointer"
          >
            Clear All 
          </button>
        </div>
