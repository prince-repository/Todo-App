...
//     <section className="grid grid-cols-6 mx-6 ">

//       <h1 className="flex items-center gap-2 text-xl w-full sm:w-auto">
...
//           }
//         }}
//         className="bg-red-500 hover:bg-red-600 text-white font-bold py-3 px-3 my-5 rounded-3xl shadow-md transition-all cursor-pointer self-center"
//       >
//         Clear All Tasks
//       </button>
//     </section>
