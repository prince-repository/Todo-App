  ...
  return (
    <div className={`flex justify-center mt-5`}>
      <form onSubmit={onHandleSubmit}>
        <div className="flex flex-row  flex-wrap gap-3 font-medium justify-center">
         ...
         <input
            ...
            value={date}
             onChange={(e) => setDate(e.target.value)}
              className={`outline-none shadow-sm px-12 py-2 shadow-gray-500 transition-all duration-500 rounded
              ${lightMode
